	...
	var Application = function () {
	    ...
	    _createClass(Application, [{
	        ...
	        value: function setupScene() {
	            ...
	            if (document.getElementById('shaders') == null) document.body.appendChild(shd);else document.getElementById('shaders').innerHTML = "";
	            ...
	            */
	            ...
	            eash.linerPostProcess(eash.cameraLayer(1), this.camera, {
	                apply: function apply(ef) {
	                    ef.setTexture('ref1', renderTarget);
	                }
	            });
	
	            eash.linerPostProcess(eash.directionBlur({
	                dir: { x: 1., y: 0.0 }, custom: function custom(dir, step, alpha) {
	                    return eash.reference('ref', eash.cameraShot({ uv: 'uv+' + dir })) + eash.replace({ type: black, area: 0, opacity: 0.48, mat: eash.solid(0x000000, 0.0) }) + eash.replace({ type: white, area: 0, opacity: 0.7, mat: eash.solid(0xffffff, 1.0) });
	                }, percent: 10.
